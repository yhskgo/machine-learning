...
class Command(BaseCommand):
    def add_arguments(self, parser):
        ...
        parser.add_argument('--nmaxwords', '--nmaxwords', dest='nmaxwords',
                             type=int, action='store',
                             help=('nmaxwords')),
        parser.add_argument('--umatrixfile', '--umatrixfile', dest='umatrixfile',
                             type=str, action='store',
                             help=('umatrixfile')),
...
class LogLikelihood(object):
    ...
    def loglikelihood_ratio(self):
        ...
        for i in list(range(nitems)):
            for j in list(range(nitems)):
                if (j >= i):
    ...
    def GetRecItems(self, u_vec, indxs=False):
        ...
        seenindxs = [indx for indx in list(range(len(u_vec))) if u_vec[indx] > 0]
